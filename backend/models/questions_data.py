...
TEST1 = [
  ...
  # ── Teil 3: Leseverstehen / Textauswahl ──────────────────────────────────
  {
    ...
    "context":"TEXT A — Homeoffice\nDas Arbeiten von zu Hause hat stark zugenommen. Viele Arbeitnehmer schätzen die Flexibilität. Manche berichten jedoch von Einsamkeit und fehlendem Kontakt zu Kollegen.\n\nTEXT B — Urlaub in den Alpen\nIm Sommer fahren viele Deutsche in die Alpen. Frische Luft und Wanderwege machen die Region attraktiv. Hotels in Bayern und Tirol sind oft Monate im Voraus ausgebucht.\n\nTEXT C — Digitale Bezahlmethoden\nBargeld wird in Deutschland immer seltener eingesetzt. Karte und Smartphone dominieren den Alltag. Experten sagen voraus, dass Bargeld in zehn Jahren kaum noch genutzt wird.",
  ...
  },
  {
    ...
    "context":"TEXT D — Gesunde Ernährung\nImmer mehr Menschen achten auf ihre Ernährung. Bio-Produkte sind gefragt, vegane Gerichte gewinnen an Bedeutung. Ältere Generationen halten häufiger an traditionellen Fleischgerichten fest.\n\nTEXT E — Öffentlicher Nahverkehr\nDie Bundesregierung investiert Milliarden in den Ausbau des Nahverkehrs. Das 49-Euro-Ticket war ein großer Erfolg und wurde von Millionen Menschen täglich genutzt.\n\nTEXT F — Lernen als Erwachsener\nErwachsene lernen anders als Kinder: Sie brauchen Kontext und praktische Anwendung. Experten empfehlen, täglich mindestens 20 Minuten zu üben, um stetige Fortschritte zu erzielen.",
  ...
  },
  {
    ...
    "context":"TEXT G — Wohnungsmarkt in Großstädten\nIn München, Berlin und Hamburg steigen die Mieten seit Jahren stark an. Viele junge Menschen können sich keine eigene Wohnung leisten und wählen Wohngemeinschaften.\n\nTEXT H — Klimawandel und Extremwetter\nHitzewellen, Überschwemmungen und Stürme häufen sich in Deutschland. Wissenschaftler warnen vor noch gravierenderen Folgen ohne CO₂-Reduktion.\n\nTEXT I — Soziale Medien und Jugendliche\nJugendliche verbringen täglich mehrere Stunden in sozialen Netzwerken. Studien zeigen: Viele berichten von Schlafproblemen und sozialem Druck durch Vergleiche.",
  ...
  },
  {
    ...
    "context":"TEXT J — Ehrenamt in Deutschland\nJeder dritte Deutsche engagiert sich regelmäßig ehrenamtlich — in Vereinen, Schulen oder Sozialdiensten. Besonders aktiv sind Rentner und Schüler.\n\nTEXT K — Digitale Technologie im Alltag\nSmartphones und KI-Assistenten erleichtern den Alltag. Experten warnen jedoch: Nutzerdaten werden oft ohne explizite Zustimmung gesammelt.\n\nTEXT L — Sport und Gesellschaft\nGroße Sportereignisse wie die Fußball-WM verbinden Nationen. Kritiker bemängeln aber die zunehmende Kommerzialisierung und astronomische Profigehälter.",
...
TEST2 = [
  ...
  # ── Teil 3: Leseverstehen / Textauswahl ──────────────────────────────────
  {
    ...
    "context":"TEXT A — Stadtbibliothek\nDie Stadtbibliothek bietet Bücher- und Medienverleih sowie Kurse, Lesungen und Workshops an. Die Jahresmitgliedschaft kostet 20 Euro. Kinder unter 18 Jahren erhalten kostenlosen Zugang.\n\nTEXT B — Fitnessstudio\nUnser Studio ist 365 Tage geöffnet. Wir bieten Gerätetraining, Kurse und persönliche Trainingsberatung. Monatsbeitrag ab 29 Euro.\n\nTEXT C — Volkshochschule\nDie VHS bietet Kurse in Sprachen, EDV, Kochen und Kreativität an. Viele Kurse sind auch online verfügbar. Förderungen für Geringverdiener sind möglich.",
  ...
  },
  {
    ...
    "context":"TEXT D — Vegetarische Ernährung\nImmer mehr Menschen verzichten auf Fleisch. Gründe sind Gesundheit, Tierschutz und Umwelt. Vegetarische Restaurants sind in Städten weit verbreitet. Rund 10 % der Deutschen ernähren sich vegetarisch.\n\nTEXT E — Fast Food und Gesundheit\nFast Food ist schnell und günstig, aber oft kalorienreich und nährstoffarm. Regelmäßiger Konsum erhöht laut Ernährungsexperten das Risiko für Herzerkrankungen und Diabetes.\n\nTEXT F — Intermittierendes Fasten\nBeim intermittierenden Fasten isst man nur innerhalb eines bestimmten Zeitfensters, z. B. 8 Stunden. Studien zeigen positive Effekte auf Gewicht und Blutwerte.",
  ...
  },
  {
    ...
    "context":"TEXT G — Lehrermangel in Deutschland\nDeutschland hat einen akuten Lehrermangel, besonders in MINT-Fächern. Viele Bundesländer werben im Ausland. Quereinsteiger werden vermehrt in den Schuldienst aufgenommen.\n\nTEXT H — Digitalisierung an Schulen\nTablets, digitale Tafeln und Lernplattformen gehören in vielen Schulen bereits zum Alltag. Kritiker bemängeln jedoch fehlende Lehrerausbildung im digitalen Bereich.\n\nTEXT I — PISA-Studie\nDie neueste PISA-Studie zeigt, dass deutsche Schüler in Mathematik und Lesen im internationalen Vergleich zurückgefallen sind. Experten fordern mehr Investitionen in Bildung.",
  ...
  },
  {
    ...
    "context":"TEXT J — Bahnreisen in Deutschland\nDie Deutsche Bahn betreibt eines der größten Schienennetze Europas. Ferntickets sind günstig, wenn man früh bucht. Verspätungen bleiben ein häufiges Problem.\n\nTEXT K — Carsharing\nCarsharing wächst in deutschen Städten rasant. Man zahlt nur für die genutzte Zeit ohne Versicherungs- und Wartungskosten. Ideal für gelegentliche Autonutzer.\n\nTEXT L — Fahrradkultur\nDeutschland investiert stark in Fahrradinfrastruktur. In Städten wie Münster und Freiburg fährt mehr als ein Drittel regelmäßig Rad. Neue Radschnellwege sollen das Pendeln erleichtern.",
...
TEST3 = [
  ...
  # ── Teil 3: Leseverstehen / Textauswahl ──────────────────────────────────
  {
    ...
    "context":"TEXT A — Kaffeekultur in Deutschland\nDeutschland gehört zu den größten Kaffeekonsumländern der Welt. Kaffeehäuser und Röstereien erleben einen Boom. Filterkaffee ist besonders bei jüngeren Generationen wieder trendy. Nachhaltigkeit spielt beim Kauf eine zunehmende Rolle.\n\nTEXT B — Teekultur in Ostfriesland\nOstfriesland hat eine einzigartige Teekultur: Schwarztee wird mit Kandiszucker und einem Schuss Sahne getrunken, ohne Umrühren. Diese Tradition besteht seit Jahrhunderten und hat EU-Schutzstatus.\n\nTEXT C — Craft-Beer-Bewegung\nKleine, unabhängige Brauereien gewinnen in Deutschland an Bedeutung. Craft Biere zeichnen sich durch experimentelle Aromen und handwerkliche Produktion aus. Viele Brauereien bieten Führungen und Verkostungen an.",
  ...
  },
  {
    ...
    "context":"TEXT D — KI im Büro\nKI-Werkzeuge verändern die Arbeitswelt: Texte werden automatisch verfasst, Daten analysiert, Meetings transkribiert. Arbeitnehmer müssen neue Kompetenzen erwerben.\n\nTEXT E — Homeoffice-Regelungen\nNach der Pandemie haben viele Unternehmen feste Homeoffice-Regelungen eingeführt. 2–3 Tage pro Woche von zu Hause ist in vielen Branchen Standard. Einige Firmen kehren jedoch zum Präsenzbetrieb zurück.\n\nTEXT F — Viertagewoche\nMehrere Unternehmen in Deutschland testen die Viertagewoche ohne Lohnkürzung. Erste Ergebnisse zeigen gesteigerte Produktivität und höhere Mitarbeiterzufriedenheit.",
  ...
  },
  {
    ...
    "context":"TEXT G — Das deutsche Schulsystem\nDas deutsche Schulsystem ist föderalistisch: Jedes der 16 Bundesländer regelt sein Bildungswesen selbst. Kritiker fordern mehr Einheitlichkeit, um Schülern nach einem Umzug den Neustart zu erleichtern.\n\nTEXT H — Duale Ausbildung\nDie duale Ausbildung kombiniert Betrieb und Berufsschule und gilt international als Vorbild. Auszubildende verdienen bereits während der Ausbildung ein Gehalt.\n\nTEXT I — Hochschulzugang\nDas Abitur ist die klassische Zugangsberechtigung für ein Studium. Alternativ gibt es die Fachhochschulreife oder besondere Zulassungsverfahren für beruflich Qualifizierte.",
  ...
  },
  {
    ...
    "context":"TEXT J — Tourismus in Berlin\nBerlin ist eines der beliebtesten Reiseziele Europas mit über 13 Millionen Besuchern jährlich. Besonders gefragt: Museen, die Mauer-Gedenkstätte und das Nachtleben.\n\nTEXT K — Oktoberfest München\nDas Oktoberfest ist das größte Volksfest der Welt mit rund 6 Millionen Besuchern jährlich. Es generiert etwa 1 Milliarde Euro Umsatz für die Stadt München.\n\nTEXT L — Romantische Straße\nDie Romantische Straße führt von Würzburg nach Füssen und verbindet historische Städte und Schlösser, darunter das weltbekannte Schloss Neuschwanstein.",
...
TEST4 = [
  ...
  # ── Teil 3: Leseverstehen / Textauswahl ──────────────────────────────────
  {
    ...
    "context":"TEXT A — Digitales Ehrenamt\nImmer mehr Menschen engagieren sich online: als Wikipedia-Autoren, in Beratungsportalen oder als digitale Nachhilfelehrer. Experten sehen digitales Ehrenamt als Ergänzung — nicht als Ersatz — für klassisches Engagement.\n\nTEXT B — Integration durch Sport\nSportvereine leisten wichtige Integrationsarbeit. Gemeinsames Training verbindet Einheimische und Zugewanderte, überwindet Sprachbarrieren und schafft soziale Netzwerke.\n\nTEXT C — Mehrgenerationenhäuser\nIn Mehrgenerationenhäusern leben Jung und Alt zusammen. Rentner betreuen Kinder, Jüngere helfen beim Einkauf. Solche Projekte fördern den gesellschaftlichen Zusammenhalt.",
  ...
  },
  {
    ...
    "context":"TEXT D — Elektromobilität\nElektroautos werden in Deutschland immer beliebter. Staatliche Förderungen und sinkende Akkupreise machen sie erschwinglicher. Die Ladeinfrastruktur bleibt jedoch problematisch, besonders auf dem Land.\n\nTEXT E — Wasserstoffantrieb\nWasserstoff gilt als Energieträger der Zukunft, besonders für Nutzfahrzeuge und Langstrecken. Deutschland investiert Milliarden in die Technologie. Bis zur Marktreife ist es jedoch noch ein weiter Weg.\n\nTEXT F — Autonomes Fahren\nSelbstfahrende Autos werden in Deutschland intensiv erprobt. Sicherheitsfragen und rechtliche Hürden bremsen die breite Einführung. Experten rechnen mit Marktreife erst nach 2030.",
  ...
  },
  {
    ...
    "context":"TEXT G — Altersarmut in Deutschland\nTrotz einer starken Volkswirtschaft wächst die Altersarmut. Viele Rentner erhalten unter 1.000 Euro monatlich. Besonders betroffen sind Frauen und Menschen mit unterbrochenen Erwerbsbiografien.\n\nTEXT H — Pflege im Alter\nDer Pflegebedarf steigt mit der alternden Gesellschaft. Pflegeheime sind oft ausgelastet und teuer. Viele Familien pflegen Angehörige zu Hause, was zur Doppelbelastung führen kann.\n\nTEXT I — Silver Economy\nÄltere Konsumenten werden eine immer wichtigere Zielgruppe. Die Silver Economy umfasst Produkte und Dienste speziell für Menschen ab 60: Reisen, Gesundheit und Smart-Home-Lösungen.",
  ...
  },
  {
    ...
    "context":"TEXT J — Urban Gardening\nStadtbewohner legen Gemüse- und Kräutergärten auf Balkonen, Dächern oder in Gemeinschaftsgärten an. Urban Gardening verbindet Nachhaltigkeit, soziale Interaktion und gesunde Ernährung.\n\nTEXT K — Lebensmittelverschwendung\nIn Deutschland werden jährlich rund 12 Millionen Tonnen Lebensmittel weggeworfen. Initiativen wie 'Too Good To Go' kämpfen dagegen.\n\nTEXT L — Regionale Produkte\nEinkaufen beim Bauernmarkt oder direkt beim Erzeuger liegt im Trend. Regionale Produkte sind frischer und stärken die lokale Wirtschaft. Wochenmärkte erleben eine Renaissance.",
...
TEST5 = [
  ...
  # ── Teil 3: Leseverstehen / Textauswahl ──────────────────────────────────
  {
    ...
    "context":"TEXT A — Mehrsprachigkeit in Deutschland\nIn Deutschland sprechen über 20 % der Bevölkerung zu Hause eine andere Sprache als Deutsch. Mehrsprachigkeit wird zunehmend als Ressource betrachtet. Studien zeigen, dass mehrsprachige Kinder oft bessere kognitive Flexibilität entwickeln.\n\nTEXT B — Deutsch als Fremdsprache\nDeutsch ist die dritthäufigste Unterrichtssprache in der EU. Weltweit lernen über 15 Millionen Menschen Deutsch. Deutschland und Österreich investieren stark in Sprachförderung im Ausland.\n\nTEXT C — Dialekte in Deutschland\nDeutschland hat eine reiche Dialektlandschaft: Bairisch, Schwäbisch, Plattdeutsch und viele mehr. Dialekte schaffen regionale Identität, werden aber im öffentlichen Leben seltener. Junge Menschen sprechen häufiger Standarddeutsch.",
  ...
  },
  {
    ...
    "context":"TEXT D — Stadtplanung der Zukunft\nModerne Städte setzen auf Schwammstadt-Konzepte: Grünflächen und durchlässige Böden speichern Regenwasser und kühlen das Stadtklima. Ziel: Hitzewellen und Überschwemmungen besser bewältigen.\n\nTEXT E — Smart City\nSmarte Städte nutzen Daten und Technologie, um Verkehr, Energie und Abfall effizienter zu verwalten. Sensoren messen Luftqualität in Echtzeit. Datenschutz ist dabei ein wichtiges Thema.\n\nTEXT F — Neue Wohnformen\nCo-Living-Konzepte und Tiny Houses liegen im Trend. Menschen teilen Gemeinschaftsflächen und reduzieren ihren Wohnraumbedarf. Das spart Kosten und fördert soziale Kontakte.",
  ...
  },
  {
    ...
    "context":"TEXT G — Burnout und Erholung\nBurnout ist eine ernsthafte Folge chronischen Stresses. Symptome: Erschöpfung, Motivationsverlust, Zynismus. Therapie erfordert Auszeit, Psychotherapie und langfristige Lebensstiländerungen.\n\nTEXT H — Achtsamkeit und Meditation\nAchtsamkeitsübungen haben sich als wirksam gegen Stress und Angst erwiesen. Apps wie Headspace oder Calm haben Millionen Nutzer. Auch Unternehmen bieten Achtsamkeitstraining an.\n\nTEXT I — Sport als Stressbewältigung\nKörperliche Aktivität baut Stresshormone ab und verbessert die Stimmung. Schon 30 Minuten moderater Sport täglich haben nachweislich positive Effekte auf die psychische Gesundheit.",
  ...
  },
  {
    ...
    "context":"TEXT J — Tierschutz in Deutschland\nDeutschland hat eines der strengsten Tierschutzgesetze der Welt. Trotzdem leiden Millionen Nutztiere in der Massentierhaltung. Tierschutzorganisationen fordern schärfere Kontrollen.\n\nTEXT K — Haustiere und Einsamkeit\nStudien zeigen: Haustierbesitzer fühlen sich weniger einsam. Besonders Hunde und Katzen bieten emotionale Unterstützung. In Altenheimen werden Therapietiere eingesetzt.\n\nTEXT L — Vegane Ernährung und Umwelt\nVegane Ernährung kann den CO₂-Fußabdruck erheblich reduzieren. Pflanzliche Produkte verbrauchen weniger Wasser und Fläche. Kritiker wenden ein, dass vegane Ernährung nicht für alle kulturell oder finanziell zugänglich ist.",
